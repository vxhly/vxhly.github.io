...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上诉办法是在需要清除浮动的地方加个 div.clear 或者 br.clear, 我们知道这样能解决基本清浮动问题。 但是这种方法的最大缺陷就是改变了 html 结构, 虽然只是加个 div</p>`,6);function m(b,h){const a=l("ExternalLinkIcon");return t(),p("div",null,[d,c(" more "),r,n("p",null,[n("a",k,[o("codepen 调试地址"),i(a)])]),v])}const f=e(u,[["render",m],["__file","css-cold-knowledge.html.vue"]]);export{f as default};
