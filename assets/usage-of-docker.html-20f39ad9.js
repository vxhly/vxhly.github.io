...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>设置完用 <code>git config --list</code> 进行检验, 之后的 commit 操作就在 docker 容器下执行就行了</p>`,11);function U(C,I){const a=o("ExternalLinkIcon");return l(),p("div",null,[u,c(" more "),d,k,m,n("div",v,[b,n("p",null,[s("这里只找到了英文的文档, 所以英文不好的慎阅 "),n("a",h,[s("官方 docker 文档"),e(a)]),s(),n("a",g,[s("非官方 docker 整理文档"),e(a)])])]),y,n("p",null,[s("关于 webpack 的轮询功能 => "),n("a",f,[s("webpack"),e(a)])]),_,n("p",null,[s("关于 "),n("a",q,[s("github:dart-sass"),e(a)]),s(),n("a",x,[s("dart-sass"),e(a)])]),n("p",null,[s("因为使用 "),w,s(" 无论是在 Windows 环境下还是在 docker 的 liunx 环境下都需要依赖 "),S,s(" 和 "),O,s(" , 有的时候会出现编译错误（指的是在执行 "),R,s(" 安装 "),D,s(" 的时候由于部分库不齐备或者是编译原因导致 "),A,s(" 无法正常安装）, 所以使用 "),T,s(" 来代替 "),L,s(" 是个不错的选择, 至少目前在自测中是没有出现编译问题的, 至于兼容性问题, GitHub 文档中也给出承诺 "),n("a",N,[s("Browser Compatibility"),e(a)])]),M])}const B=i(r,[["render",U],["__file","usage-of-docker.html.vue"]]);export{B as default};
