import{_ as t,Y as p,Z as e,a1 as o,$ as n,a0 as s,a3 as c,a2 as i,C as l}from"./framework-96e1cf04.js";const u={},r=n("div",{class:"hint-container tip"},[n("p",{class:"hint-container-title"},"前言"),n("p",null,"前后端分离的时候, 通常后端要求前端发送 JSON 请求, 而后端返回的格式也是 JSON 的, 这时候就需要一个中间插件 axios 上场, 本篇文章主要介绍在 vuejs 项目中是如何二次封装 axios 的, 本篇适宜阅读人群为有一些的 Vue.js 的开发基础经验。")],-1),k=n("h2",{id:"关于-axios",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#关于-axios","aria-hidden":"true"},"#"),s(" 关于 axios")],-1),d={class:"hint-container tip"},v=n("p",{class:"hint-container-title"},"介绍",-1),m={href:"https://github.com/axios/axios",target:"_blank",rel:"noopener noreferrer"},b=i(`<h2 id="二次封装-axios" tabindex="-1"><a class="header-anchor" href="#二次封装-axios" aria-hidden="true">#</a> 二次封装 axios</h2><h3 id="安装依赖" tabindex="-1"><a class="header-anchor" href="#安装依赖" aria-hidden="true">#</a> 安装依赖</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> i axios
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,18);function y(h,w){const a=l("ExternalLinkIcon");return p(),e("div",null,[r,o(" more "),k,n("div",d,[v,n("p",null,[s("Axios 是一个基于 promise 的 HTTP 库, 可以用在浏览器和 node.js 中。更多的介绍, 米娜桑上 GitHub 查看官方说明, "),n("a",m,[s("axios"),c(a)]),s(", 这里不做过多的阐述")])]),b])}const f=t(u,[["render",y],["__file","vuejs-axios.html.vue"]]);export{f as default};
