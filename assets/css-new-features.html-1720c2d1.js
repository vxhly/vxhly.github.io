...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="支持情况-2" tabindex="-1"><a class="header-anchor" href="#支持情况-2" aria-hidden="true">#</a> 支持情况</h3><figure><img src="`+l+'" alt="CSS 的新特性" tabindex="0" loading="lazy"><figcaption>CSS 的新特性</figcaption></figure>',34);function v(k,m){return a(),e("div",null,[r,t(" more "),d])}const h=s(u,[["render",v],["__file","css-new-features.html.vue"]]);export{h as default};
