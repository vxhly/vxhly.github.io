...
- 【项目”镀金“】镀金是往往是项目人员为了“讨好”客户而做的不解决实际问题、没有应用价值的项目活动
- 【范围蔓延】指项目范围没有很好的控制，项目工作范围超出了项目立项时的范围
- 【项目终止】达成项目目标、不会或不能达到目标、项目资金缺乏或没有可分配资金、项目需求不复存在（客户要求终止、组织管理层要求终止、战略或优先级变更致使终止）、无法获得所需人力或物力资源、法律或便利原因终止
...
- 【敏感性分析】用于定量风险风险, 是为了确定不确定性给项目带来的大影响, 考察每个因素的变化会对目标产生多大程度的影响, 即龙卷风图
...
- 【相关方登记册】记录的是相关方身份信息、评估信息、相关方分类、相关方的影响力, 没有参与度
- 【相关方参与计划】记录相关方的管理策略
...
- 【”已知-已知“ 风险】指的是已识别, 可对这些风险规划应对措施（计入时间/成本）
- 【“已知-未知” 风险】指的是已识别, 但是无法（或不需要）主动管理的风险, 分配应急储备
- 【“未知-未知” 风险】指的是未识别, 无法进行主动管理, 因此需要预留一定的管理储备
- 【”威胁“应对策略】上报（对于被上报的威胁, 组织中的相关人员必须愿意承担应对责任）、规避（适用于发生概率较高, 且具有严重负面影响的高优先威胁）、转移（通常需要支付风险转移费用, 转移风险是把风险管理责任简单地推给另一方, 而并非消除风险）、减轻（它意味着把不利风险的概率和 / 或影响降低到可接受的临界值范围内）、接受（适用于低优先级威胁, 或无法以任何其他方式加以经济有效地应对的威胁）
- 【“机会”应对策略】上报（对于被上报的机会, 组织中的相关人员必须愿意承担应对责任）、开拓（适用于高优先级机会）、分享（必须仔细为已分享的机会安排新的责任人）、提高、接受（适用于低优先级威胁, 或无法以任何其他方式加以经济有效地应对的威胁）
- 【主动”接受“风险/机会】应当建立应急储备
- 【被动”接受“风险/机会】记录策略, 无需任何其他行动, 需要定期复查
...
- 【仆人式领导】在实践中进行试验且允许犯错, 是提高创造性能力最好的方法
