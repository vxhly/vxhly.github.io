...
export default hopeTheme({
  ...
  blog: {
    medias: {
      ...
      Email: "mailto:pengchengou@gmail.com",
      ...
      Rss: "https://vxhly.github.io/rss.xml",
  ...
  plugins: {
    ...
    pwa: {
      ...
      appendBase: true,
      apple: {
        icon: "icon/apple-icon-152.png",
        statusBarColor: "black",
      },
      msTile: {
        image: "icon/ms-icon-144.png",
        color: "#ffffff",
      },
      manifest: {
        icons: [
          {
            src: "/icon/chrome-mask-512.png",
            sizes: "512x512",
            purpose: "maskable",
            type: "image/png",
          },
          {
            src: "/icon/chrome-mask-192.png",
            sizes: "192x192",
            purpose: "maskable",
            type: "image/png",
          },
          {
            src: "/icon/chrome-512.png",
            sizes: "512x512",
            type: "image/png",
          },
          {
            src: "/icon/chrome-192.png",
            sizes: "192x192",
            type: "image/png",
          },
        ],
        shortcuts: [
          {
            ...
            short_name: "vxhly.github.io",
            url: "https://vxhly.github.io",
            icons: [
              {
                src: "/icon/guide-maskable.png",
                sizes: "192x192",
                purpose: "maskable",
                type: "image/png",
              },
