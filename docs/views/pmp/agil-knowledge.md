...
1. 产品负责人（PO）=> 理解并传达需求, 对需求进行收集、管理和优先级排序, 与开发团队协作并回答问题, 接受或拒绝完成的成果。指导产品的开发方向；创建、维护产品待办事项；根据商业价值排序任务；提供反馈。
2. Scrum 主管（团队促进者） => 召开每日站会、保护团队不受外部干扰, 仆人式领导。确保遵循敏捷流程；引导、指导、消除障
碍。
3. 开发团队（跨职能团队成员） => 完成需要交付的成果, 自组织和自我管理, 通用的专才（一专多能）。拥有各种必要技能；以常规节奏交付潜在可发布产品；核心职责是在短时间内交付任务。
## 项目经理作为仆人式领导的职责
