...
- 产品负责人（PO）=> 理解并传达需求, 对需求进行收集、管理和优先级排序, 与开发团队协作并回答问题, 接受或拒绝完成的成果。
- Scrum 主管 => 召开每日站会、保护团队不受外部干扰, 仆人式领导。
- 开发团队 => 完成需要交付的成果, 自组织和自我管理, 通用的专才（一专多能）。
